...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF9052);
  late Color secondary = const Color(0xFFFCCEB4);
  late Color tertiary = const Color(0xFFAEDADB);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF1F1F21);
  late Color secondaryText = const Color(0xFF55504D);
  late Color primaryBackground = const Color(0xFFFAF8F7);
  late Color secondaryBackground = const Color(0xFFF0EEED);
  late Color accent1 = const Color(0xFFEB4125);
  late Color accent2 = const Color(0xFF61D4E7);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xB2262D34);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFF90851);
  late Color info = const Color(0xFFFFFFFF);

  late Color orange2 = const Color(0xFFFE6E06);
}
