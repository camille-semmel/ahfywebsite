                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            'We use the data we collect for the following reasons:\n\n • Service Provision: To provide, personalize, and maintain your Ahfy experience.\n\n • Improvement: To analyze usage trends, provide customer support, and improve app functionality.\n\n • Security & Compliance: To ensure app security, track bugs, and comply with legal obligations.\n\n • Marketing & Communication: To send personalized content or marketing, only if you have consented.',
                            style: FlutterFlowTheme.of(context)
                                .bodyLarge
                                .override(
                                  fontFamily: FlutterFlowTheme.of(context)
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            ' • Data Retention: We keep your data only as long as necessary to provide services, fulfill the purposes outlined above, and meet our legal and regulatory obligations. You can request deletion at any time.\n\n • Data Security: We employ industry-standard security measures, including encryption, secure storage, and limited access, to protect your information. However, no system is 100% secure — we strongly advise you to use strong, unique passwords and report any suspicious activity immediately.',
                            style: FlutterFlowTheme.of(context)
                                .bodyLarge
                                .override(
                                  fontFamily: FlutterFlowTheme.of(context)
